...
- Install the complete version-matched Commet documentation with the SDK artifact.
...
- Rename legacy request fields to their v8 replacements, including `featureCode` and `offerId`.
