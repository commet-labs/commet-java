...
public final class CreateMarketGroupParams {
    ...
    private CreateMarketGroupParams(Builder builder) {
    ...
    public static final class Builder {
        ...
        public CreateMarketGroupParams build() {
            return new CreateMarketGroupParams(this);
        }
    }
}
