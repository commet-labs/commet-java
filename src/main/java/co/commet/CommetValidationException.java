...
public class CommetValidationException extends CommetException {
    ...
    public CommetValidationException(String message, int statusCode,
                                     Map<String, List<String>> validationErrors) {
        this(message, statusCode, validationErrors, null, null, null, null, null);
    }

    public CommetValidationException(String message, int statusCode,
                                     Map<String, List<String>> validationErrors, Object details,
                                     String type, String param, String docUrl, String requestId) {
        super(message, type, "validation_error", statusCode, details, param, docUrl, requestId);
